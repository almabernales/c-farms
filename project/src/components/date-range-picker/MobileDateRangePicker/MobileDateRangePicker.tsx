...
const PureDateInputComponent =
  DateRangePickerInput as unknown as React.FC<DateInputPropsLike>
...
type MobileDateRangePickerComponent = (<TInputDate, TDate = TInputDate>(
  props: MobileDateRangePickerProps<TInputDate, TDate> &
 ...
 */
export const MobileDateRangePicker = React.forwardRef(
  function MobileDateRangePicker<TInputDate, TDate = TInputDate>(
    inProps: MobileDateRangePickerProps<TInputDate, TDate>,
