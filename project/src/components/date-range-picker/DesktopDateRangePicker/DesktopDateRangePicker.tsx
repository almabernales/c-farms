...
const KeyboardDateInputComponent =
...
type DesktopDateRangePickerComponent = (<TInputDate, TDate = TInputDate>(
  props: DesktopDateRangePickerProps<TInputDate, TDate> &
 ...
 */
export const DesktopDateRangePicker = React.forwardRef(
  function DesktopDateRangePicker<TInputDate, TDate = TInputDate>(
