 ...
 */
export const DateRangePickerToolbar = React.forwardRef(
  function DateRangePickerToolbar<TDate extends unknown>(
    ...
    const toolbarTitle =
      toolbarTitleProp ?? localeText.dateRangePickerDefaultToolbarTitle
