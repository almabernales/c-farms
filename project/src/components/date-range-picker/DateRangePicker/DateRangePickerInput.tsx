...
export interface DateRangePickerInputProps<TInputDate, TDate>
  extends ExportedDateRangePickerInputProps<TInputDate, TDate>,
    Omit<
      ...
      | keyof ExportedDateRangePickerInputProps<TInputDate, TDate>
      | 'rawValue'
      | 'validationError'
    >,
    CurrentlySelectingRangeEndProps {
...
type DatePickerInputComponent = <TInputDate, TDate>(
  props: DateRangePickerInputProps<TInputDate, TDate> &
...
export const DateRangePickerInput = React.forwardRef(
  function DateRangePickerInput<TInputDate, TDate>(
